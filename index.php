  ...
  ?>
    ...
    <div class="container-fluid">
        ...
        <div class="intro py-1">
            <div >
                <div >
                   <center> <h1>Welcome to GRIP Bank</h1></center>
                </div>
            </div>
        ...
        <div class="row activity text-center">
            ...
            <div class="col-md act">
                ...
                <br><br>
                <a href="transfermoney.php"><button>View Users</button></a>
            </div>
            <div class="col-md act">
                <br><br>
    ...
    <footer class="text-center mt-5 py-2">
        <p>Made by <b>Varsha Sharma</b> <br> For <b>The Sparks Foundation</b></p>
    </footer>
